...
import { SUB_ACTION } from '../../../common/keep/constants';
import { KEEP_CONNECTOR_ID, KEEP_CONNECTOR_TITLE } from '../../../common/keep/constants';
import { KeepActionParams, KeepConnector } from './types';
...
export function getConnectorType(): KeepConnector {
  return {
    id: KEEP_CONNECTOR_ID,
    iconClass: lazy(() => import('./logo')),
    isExperimental: true,
    selectMessage: i18n.translate('xpack.stackConnectors.components.inference.selectMessageText', {
      defaultMessage: 'Connect with Keep providers',
    }),
    selectMessagePreconfigured: i18n.translate(
      'xpack.stackConnectors.components.inference.selectMessagePreconfiguredText',
      {
        defaultMessage: 'Use Keep to build workflow automation.',
      }
    ),
    actionTypeTitle: KEEP_CONNECTOR_TITLE,
    validateParams: async (
      actionParams: KeepActionParams
