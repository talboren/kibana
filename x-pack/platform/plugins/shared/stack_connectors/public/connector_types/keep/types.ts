...
export type KeepConnector = ConnectorTypeModel<Config, Secrets, KeepActionParams>;

export type KeepActionConnector = UserConfiguredActionConnector<Config, Secrets>;
